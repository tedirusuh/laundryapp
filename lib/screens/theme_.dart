...
// Kelas ThemeProvider menggunakan 'with ChangeNotifier' agar bisa
// memberi tahu widget lain ketika datanya berubah.
class ThemeProvider with ChangeNotifier {
  ...
  void toggleTheme() {
    ...
    // Ini adalah bagian terpenting: memberi tahu semua widget yang
    // 'mendengarkan' provider ini bahwa ada perubahan data,
    // sehingga mereka bisa membangun ulang dirinya dengan tema yang baru.
    notifyListeners();
  }
}
